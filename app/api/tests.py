...
def delete_test(
    test_id: int,
    dni: str = Query(..., description="User DNI (teacher can delete any, students can delete their own)"),
):
    """
...
def create_study_mode_test(
    ...
    try:
        with conn.cursor() as cur:
            ...
            description = f"Practice test with {len(wrong_questions)} questions you got wrong"
